...
public class HotelServiceImpl implements IHotelService {
	...
	@Override
	public List<Hotel> getByRatings(double rating) {
...
// 
	...
	public List<Hotel> getByCusine(String cusine) {
		return hotelRepository.findByCusine(cusine);
	}
	...
	@Override
	public List<Hotel> getByCusineAndType(String cusine, Type type) {
		return hotelRepository.findByCusineAndType(cusine, type);
	}
